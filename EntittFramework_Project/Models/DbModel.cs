...
namespace EntittFramework_Project.Models
{
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            for (int i = 1; i <= 5; i++)
            {
                modelBuilder.Entity<Product>().HasData(
                  new Product { ProductId = i, ProductName = "Product " + i, Size = (Size)random.Next(1, 5), Price = random.Next(1000, 2000) * 1.00M, OnSale = true, Picture = i + ".jpg" }
